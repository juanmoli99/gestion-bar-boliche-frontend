...
export function FormulaForm({
  ...
  async function handleSubmit(
    ...
    try {
      ...
      setError(
        editing
          ? 'No se pudo actualizar la fórmula. Revisá los datos ingresados.'
          : 'No se pudo crear la fórmula. Revisá los datos ingresados.',
      );
    } finally {
      setSaving(false);
    }
      ...
      >
        ...
        >
          <div>
            ...
            <p>
              Identificá la fórmula que se utilizará en las reservas de fiesta.
            </p>
          </div>
        </header>
      ...
      >
        ...
        >
          <div>
            ...
            <p>
              Seleccioná los ítems y definí el consumo estimado por persona.
            </p>
          </div>
